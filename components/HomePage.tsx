...
export default function Page(){
    return(
        <>
            <div className="min-h-screen overflow-hidden flex flex-col items-center justify-center text-6xl font-bold text-slate-700
        ...
        ">
                ...
                <h1 className="mt-20 text-[3.5em] font-bold from-violet-500 to-fuchsia-600 bg-gradient-to-r bg-clip-text text-transparent">
                    Recall.
                </h1>
